...
/* let color = prompt('Введите цвет: зеленый, желтый, красный');
if (color === 'зеленый') {
    document.write('иди');
...
/* #3ДОП Все параметры получаем с клавиатуры!!!!(prompt , confirm)
...
/* let color = prompt('Введите цвет: зеленый, желтый, красный');
let isRoadClear = confirm('Выберите наличие машин на дороге: ОК - есть, Cancel - нет')
